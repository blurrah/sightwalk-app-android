...
import net.sightwalk.Controllers.Introduction.LoginActivity;
...
/**
 * Created by Ruben on 22/11/2015.
 */
    ...
    protected void onPostExecute(String response) {
        ...
        try {
            ...
            if(requestStatus){
                ...
                Toast.makeText(appContext, "Wrong credentials", Toast.LENGTH_SHORT).show();
            }
